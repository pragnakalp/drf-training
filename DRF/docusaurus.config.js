...
const config = {
  title: 'drf training',
  tagline: 'Practical Django REST Framework training focused on clean API design, security, performance, and production deployment.',
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/pragnakalp/drf-training/tree/main/',
        },
        blog: false,
        theme: {
